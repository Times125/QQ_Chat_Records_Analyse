...
def analyse():
    ...
    most_active_person = dict([(k, v) for k, v in counter_res.most_common(25)])  # 最活跃的25个人
    ...
    hours_counter = dict([(int(k), v) for k, v in hours_counter_res.most_common(24)])
    tmp = [i for i in range(24)]
    x1 = []
    y1 = []
    for i in tmp:
        x1.append(i)
        if i in hours_counter:
            y1.append(hours_counter[i])
        else:
            y1.append(0)
    print(hours_counter)
    # 解决中文乱码问题
    ...
    plt.title('重庆老乡群群友活跃分布')
    plt.ylabel('记录条数')  # 设置y轴标签
    plt.xlabel('时刻')  # 设置x轴标签
    plt.xticks(range(24), x1)
    plt.legend()
    plt.plot(x1, y1, marker='*', ms=10, color='y')  # 绘制折线图
    plt.show()
    ...
    for qq in most_active_person:
        ...
        pool.apply_async(emotion_analyse, (que, txt, qq))
        txt = []
    pool.close()
    pool.join()
    ...
    while not que.empty():
        print('this is while')
        qq, sentiment_index = que.get(True)
        user_sentiment[qq] = sentiment_index
        x.append(qq)
        y.append(sentiment_index)
    ...
    半年：2017/07 -- 2018/01 {'1209101643': 0.5427812816478225, '745500530': 0.5507599248949117, '1051617442': 
    ...
    0.5309849111992685, '122780300': 0.5309933866294124, '10000': 0.5284466697252308, '1227832488': 
    0.5283585964515772, '1316141782': 0.5285967890143103, '1344754848': 0.5286674077843782, '1241927211': 
    0.528424292537605, '1278678748': 0.5280859518868842, '1196042086': 0.5280284458864, '784319656': 
    0.5284060134894644, '452335534': 0.5286984475623131, '2914707056': 0.5287701425196093, '1278109751': 
    0.5290585856871963, '837125065': 0.5291170420305971, '1064278183': 0.5291016493609904, '798955866': 
    0.5294630944685925, '1085578433': 0.52930914248514, '422938365': 0.5295712616540428, '1457556035': 
    0.5296832347357361, '1129344867': 0.5296765800798483, '1822118385': 0.5297533989900461, '2422197668': 
    0.5297322708242689, '1061275041': 0.5298537037626699, '393989256': 0.5297992500496315, '1105081309': 
    0.5299694494350515, '747544291': 0.5301582266477316, '357190318': 0.5301595769523562, '121289126': 
    0.5302845157303446, '1095736889': 0.5303553062869905, '1272082503': 0.5305090612032322, '309941018': 
    0.5304935382513758, '251604829': 0.5305276413428799, '876705832': 0.5307866870732014, '1351461971': 
    0.5308601636552932, '363374239': 0.5308308896578008, '328054694': 0.5307810877049866, '504133892': 
    0.5307463796609506, '641097301': 0.5308282628491252, '506640120': 0.5308740152452233, '812749634': 
    0.5309081934474766, '961357326': 0.5310443894354496, '568588075': 0.5311020621084173, '904349494': 
    0.5311619995291751, '1098224615': 0.5311377240414275, '865845406': 0.5311768177693404, '750479251': 
    0.531187383565594, '1030201081': 0.5311473874833691, '769031687': 0.5309991086644246, '1006392533': 
    0.5309762045576085, '1009132098': 0.531084708728667, '877697004': 0.5310824284067153, '835194461': 
    0.5310894638634346, '815263592': 0.5311570717128403, '836483716': 0.5312497820063115, '295083887': 
    0.531316229230391, '986048812': 0.5312283218489628, '1732376703': 0.53123102278883, '1176781811': 
    0.531317643774081, '1146751230': 0.5313541708299178, '464870515': 0.5312882048083162, '591985453': 
    0.5313028049854518, '1503484527': 0.5313465383938655, '846522909': 0.5313583909940992, '244665984': 
    0.5313870427657331, '761631604': 0.5313994868892827, '1647036905': 0.5313838526108119, '2280737669': 
    0.5314268451643539, '505420996': 0.5315191037434139, '296585171': 0.5314684837901023, '1985059595': 
    0.5315002259629534, '3038798137': 0.5315600243751035, '1478620363': 0.5315204256725709, '1194906693': 
    0.5315078156451286, '849350590': 0.5315612858290759, '1069045056': 0.5315969839355288, '1195912410': 
    0.5316059291585217, '1172596168': 0.5315992909922406, '774110694': 0.5316443354015329} 
...
# 对单个qq用户的情感分析
def emotion_analyse(que, txt_lst=None, qq=None):
    """
    ...
    if txt_lst is None or qq is None:
        return
    print('analyse %s emotions and pid is %d and len is %d' % (qq, os.getpid(), len(txt_lst)))
    ...
    scores = sentiment_scores / len(txt_lst)
    print('task %s done! and socre is %.5f and len is %d' % (qq, scores, len(txt_lst)))
    res = (qq, scores)
    que.put(res, True)
